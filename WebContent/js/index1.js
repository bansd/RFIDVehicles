...
function checkEmail() {
	...
	xmlhttp.open("GET", "getemail.jsp?q=" + str, true);
	xmlhttp.send();
}
...
$(".submit1").click(function(){
	...
	var user_fname 		= $("form#pform input[name='fname']").val();
	var user_mname 		= $("form#pform input[name='mname']").val();
	var user_lname 		= $("form#pform input[name='lname']").val();
	var contact_no 		= $("form#pform input[name='cno']").val();
	var alternate_Contact_number 		= $("form#pform input[name='acno']").val();
	var address 		= $("form#pform input[name='address']").val();
	var state_name 		= $("form#pform select[name='state']").val();
	var city_name 		= $("form#pform select[name='city_name']").val();	
	var pin_code 		= $("form#pform input[name='pincode']").val();
	var x = email ;
	var atpos = x.indexOf("@");
	...
	if(pin_code == "") {
		...
		if(validation_holder == 1 || checkuser == 1 || checkemail == 1 || checkphone == 1 || checkaphone == 1) { // if have a field is blank, return false
